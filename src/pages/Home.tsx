      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            {/* Profile Picture */}
            <div className="flex-shrink-0 md:basis-2/5 md:max-w-[42%] flex flex-col items-center gap-4">
              <img
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-center">
                ...
                <a
                  ...
                  aria-label="GitHub"
                  className="inline-flex items-center justify-center w-11 h-11 bg-white dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-lg transition-colors border border-slate-300 dark:border-slate-700 shadow-sm"
                >
              ...
              <p className="mt-4 text-sm text-slate-600 dark:text-slate-400 uppercase tracking-wide font-semibold">
                {t('contact.portfolioLabel')}
              </p>
              <ul className="mt-3 space-y-2 text-base text-slate-800 dark:text-slate-200">
                <li>
                  <a
                    href="https://www.npmjs.com/package/ngx-herald"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a
                    href="https://hopla-challenges.netlify.app/challenge/1"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 transition-colors"
                  >
                    {t('contact.angularChallenges')}
                  </a>
                </li>
                <li>
                  <a
          ...
          <div className="max-w-lg">
            <div className="space-y-3">
              {[
                ...
                { key: 'english', level: 5, labelKey: 'fluentC2' },
                { key: 'german', level: 4, labelKey: 'fluentC1C2' },
                ...
                <div key={lang.key} className="flex items-center gap-3">
                  ...
                  <div className="flex gap-1.5 flex-1 max-w-xs">
                    ...
                    <span className="text-slate-600 dark:text-slate-400 text-xs min-w-[88px] whitespace-nowrap">{t(`languages.levels.${lang.labelKey}`)}</span>
                </div>
              ))}
            </div>
          </div>
